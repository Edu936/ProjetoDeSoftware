<div class="card-grande">
    ...
    <form action="<?= $route ?>" method="post" autocomplete="off">
        <fieldset>
            ...
            <div class="dados">
                <label for="fone">Telefone do Fornecedor:</label><br />
                <?php echo "<input type=\"tel\" name=\"DS_FONE_FORNECEDOR\" id=\"fone\" placeholder=\"Numero do Fornecedor\" required" ?>
            </div>
            <div class="dados">
                <label for="email">Email do Fornecedor:</label><br />
                <?php echo "<input type=\"email\" name=\"DS_EMAIL_FORNECEDOR\" id=\"email\" placeholder=\"Endereço email do Fornecedor\" required" ?>
            </div>
        </fieldset>
        <fieldset>
